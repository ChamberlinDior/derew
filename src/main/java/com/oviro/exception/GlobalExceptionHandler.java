...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OviroException.class)
    public ResponseEntity<ApiResponse<Void>> handleOviroException(OviroException ex) {
        log.warn("OviroException [{}]: {}", ex.getErrorCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleBadCredentials(BadCredentialsException ex) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponse.error("Identifiants incorrects", "BAD_CREDENTIALS"));
    }
